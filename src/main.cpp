...
int main(int argc, const char** argv) try {
    ...
    info("BeamMP LAN fork  -  launcher/combined build p13h38 (pairs with mod 4.22.1-LAN p13h91+; BeamNG 0.39.x; upstream 4.22.1 sync + #268/#266; mod-filename path-traversal fix a9faac2; direct vehicle socket + registration ack)");
